            ...
            Column(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .clickable { focusRequester.requestFocus() }   // 🔥 ora clicchi ovunque
                ) {
                    BasicTextField(
                        value = searchText,
                        ...
                        modifier = Modifier
                            .fillMaxWidth()
                            .focusRequester(focusRequester),            // 🔥 collega il focus
                            ...
                            Row(
                                modifier = Modifier
                                    ...
                                    .clickable {
                                        ...
                                        totaleOre =
                                            DatabaseHelper.getTotaleOreCliente(cliente.fullName) // Riepilogo ore
                                        materialiUsati =
                                            DatabaseHelper.getMaterialiUsatiDaCliente(cliente.fullName) // Riepilogo materiali usati
                                    }
                            ) {
                ...
                Column(
                    ...
                    Text("Riepilogo Cliente", fontSize = 16.sp)
                    Spacer(Modifier.height(20.dp))
                    ...
                    LazyColumn(
                        ...
                        items(materialiUsati) { (mat, qty) ->
                            Row(
                                ...
                                Text("${mat.marca} ${mat.modello}", modifier = Modifier.weight(1f), fontSize = 11.sp)
                                Text("x $qty", modifier = Modifier.weight(0.3f), fontSize = 11.sp)
                            }
                        }
                    }
                }
